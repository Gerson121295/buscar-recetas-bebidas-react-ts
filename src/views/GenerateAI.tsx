...
export default function GenerateAI() {
  ...
  //Obtiene los states y funtions del stroe
    const showNofification = useAppStore((state) => state.showNotification)
    ...
    const handleSubmit = async(e: React.SubmitEvent<HTMLFormElement>) => {
        ...
        //Crea el objeto formData en base al submit enviado
        const form = new FormData(e.currentTarget)
        const prompt = form.get('prompt') as string // ?.toString()!;

        if(prompt.trim() === ''){
            showNofification({
                text : 'La busqueda no puede ir vacio.',
                error: true
            })
            return
        }
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {
          isGenerating && <p className="text-center animate-blink">
            Generando...
          </p>
        }
